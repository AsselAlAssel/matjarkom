...
export default function StoreCard({ storeData }) {
  ...
  return (
    <Box
      ...
      sx={{
        background: `linear-gradient(rgba(0, 0, 0, 0) -34.58%, rgb(0, 0, 0) 56.09%), url(${storeData.image}) center center / cover no-repeat, 50% center / cover no-repeat lightgray`,
      }}
    >
      <div>
        <div className="mb-4">
